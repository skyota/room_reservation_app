...
from .views import HomeView, RoomView, add_reservation, get_reservations, delete_reservation
...
urlpatterns = [
    ...
    path('room/<int:pk>/list/', login_required(get_reservations), name='get_reservations'),
